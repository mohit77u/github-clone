        ...
        <div class="flex flex-wrap items-center justify-between">
            <div class="left lg:w-[350px] w-full">
                <div class="flex items-center">
                    ...
                    <input type="text" placeholder="Search or jump to..." class="border border-gray-700 focus:outline-none focus:ring-0 px-3 py-1 text-sm ml-2 rounded w-full bg-transparent text-gray-300">
            ...
            <div class="middle lg:w-5/12 w-full">
                <div class="menu flex items-center gap-x-5">
                    ...
                    <a href="#" class="text-gray-200 font-medium text-sm hover:text-gray-400">Codespaces</a>
                    <a href="#" class="text-gray-200 font-medium text-sm hover:text-gray-400">Marketplace</a>
                    <a href="#" class="text-gray-200 font-medium text-sm hover:text-gray-400">Explore</a>
                </div>
            </div>
            <div class="middle lg:w-4/12 w-full">
