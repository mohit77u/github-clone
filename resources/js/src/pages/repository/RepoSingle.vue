        ...
        <div class="repo-details py-5 px-8">
            <div class="top flex justify-between">
                ...
                <div class="right flex gap-4">
                    <button class="px-4 py-1.5 text-gray-400 border border-gray-700 rounded-md text-[12px] hover:border-gray-400 bg-white/5 flex justify-center items-center gap-2">
                    ...
                    <button class="px-4 py-1.5 text-gray-400 border border-gray-700 rounded-md text-[12px] hover:border-gray-400 bg-white/5 flex justify-center items-center gap-2" :disabled="repo.fork ? 'disabled' : ''">
                        <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1" width="16" data-view-component="true" class="fill-gray-400">
                ...
                <div class="repo-top-bar w-full p-4 rounded rounded-b-none border border-[rgba(56,139,253,0.4)] bg-gradient-to-b from-[rgba(56,139,253,0.15)] to-[rgba(56,139,253,0.15)]">
                    ...
                    <div class="url-bar flex justify-between my-2 gap-3">
                        ...
                        <div class="flex border border-gray-700 bg-dark-primary text-gray-300 font-medium rounded-md text-[12px]">
                            <button :class="['text-gray-500 px-2 py-1', ssh ? 'bg-white/5' : 'bg-transparent', 'border border-transparent hover:border-gray-400 rounded-md rounded-r-none' ]" @click="ssh = false">HTTPS</button>
                            <button :class="['text-gray-500 px-2 py-1', ssh ? 'bg-transparent' : 'bg-white/5', 'border border-transparent hover:border-gray-400 rounded-md rounded-l-none' ]" @click="ssh = true">SSH</button>
                        </div>
