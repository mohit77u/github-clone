<template>
    <div class="sidebar md:w-[350px] w-full md:sticky md:left-0 md:top-0 md:z-40 md:min-h-[50vh] md:max-h-[100vh] bg-[#0d1117] border-r border-gray-700 py-5 px-8 overflow-y-auto relative">
        ...
        <div v-else>
            ...
            <!-- search input -->
            <input type="text" placeholder="Find repository..." class="my-2 border border-gray-700 focus:border-blue-400 focus:outline focus:ring-blue-400 px-3 py-1 text-sm rounded w-full bg-dark-main text-gray-300" @keyup="searchRepo($event)">
